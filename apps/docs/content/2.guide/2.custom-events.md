...
::read-more{to=https://docs.streamer.bot/api/csharp/methods/core/websocket/broadcast-string target=_blank}
`CPH.WebsocketBroadcastString(string data)`{lang=cs}
::
::read-more{to=https://docs.streamer.bot/api/csharp/methods/core/websocket/broadcast-json target=_blank}
