...
::read-more{to=/api/requests}
Explore the [Requests API Reference](/api/requests) which documents all requests and their responses.
::
...
::warning{to=/api/requests#executecodetrigger}
